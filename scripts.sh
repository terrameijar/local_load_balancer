...
docker run --network=lb_network --rm --ip 10.0.0.3 --name flask1  -e SERVER_NAME=flask1 --cpuset-cpus="0" --memory=100m app1
docker run --network=lb_network --rm --ip 10.0.0.4 --name flask2  -e SERVER_NAME=flask2 --cpuset-cpus="0" --memory=100m app1
